...
})(PS["ScrollTable"] = PS["ScrollTable"] || {});
(function(exports) {
  // Generated by purs version 0.12.0
  "use strict";
  var $foreign = PS["ScrollTable"];
  ...
  var UserScroll = (function () {
      ...
      UserScroll.create = function (value0) {
          return function (value1) {
              return new UserScroll(value0, value1);
          };
      };
      return UserScroll;
  })();
  var tableView = function (v) {
      var makeRow = function (index) {
          ...
          var key = Data_Show.show(Data_Show.showNumber)($$Math.remainder(i)(Data_Int.toNumber(Data_Array.length(v.visibleIndices))));
          return Halogen_HTML_Elements.tr([ Halogen_HTML_Properties.id_(key), Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.absolute))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.top(CSS_Size.px(i * Data_Int.toNumber(v.rowHeight))))(function () {
                  return CSS_Geometry.width(CSS_Size.pct(Data_Int.toNumber(100)));
              });
          })) ])([ Halogen_HTML_Elements.td([ Halogen_HTML_CSS.style(CSS_Geometry.width(CSS_Size.px(Data_Int.toNumber(v.colWidth)))) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showNumber)(i)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_CSS.style(CSS_Geometry.width(CSS_Size.px(Data_Int.toNumber(v.colWidth)))) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showNumber)(i * 1.0)) ]), Halogen_HTML_Elements.td([ Halogen_HTML_CSS.style(CSS_Geometry.width(CSS_Size.px(Data_Int.toNumber(v.colWidth)))) ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showNumber)(i * 100.0)) ]) ]);
      };
      return Halogen_HTML_Elements.table([ Halogen_HTML_CSS.style(CSS_Geometry.height(CSS_Size.px(Data_Int.toNumber(v.rowCount * v.rowHeight | 0)))) ])([ Halogen_HTML_Elements.tbody_(Data_Functor.mapFlipped(Data_Functor.functorArray)(v.visibleIndices)(makeRow)) ]);
  };
  var calculateVisibleIndices = function (model) {
      return function (scrollTop) {
          var firstRow = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(scrollTop)(model.rowHeight);
          var visibleRows = Data_EuclideanRing.div(Data_EuclideanRing.euclideanRingInt)(model.height + 1 | 0)(model.rowHeight);
          ...
          return {
              ...
              visibleIndices: Data_Array.range(firstRow)(lastRow)
          };
      };
  };
  var ui = (function () {
      var inputMaybe = function (f) {
          return function (a) {
              return Data_Functor.map(Data_Maybe.functorMaybe)(Halogen_Query.action)(f(a));
          };
      };
      var render = function (st) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1([ Halogen_HTML_CSS.style(CSS_TextAlign.textAlign(CSS_TextAlign.center)) ])([ Halogen_HTML_Core.text("Scroll Table!!!") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("container"), Halogen_HTML_CSS.style(Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Display.position(CSS_Display.relative))(function () {
              return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.height(CSS_Size.px(Data_Int.toNumber(st.height))))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Geometry.width(CSS_Size.px(Data_Int.toNumber(st.width))))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(CSS_Stylesheet.bindStyleM)(CSS_Overflow.overflowX(CSS_Overflow.hidden))(function () {
                          return CSS_Border.border(CSS_Border.solid)(CSS_Size.px(1.0))(Color.black);
                      });
                  });
              });
          })), Halogen_HTML_Events.onScroll(inputMaybe(function (e) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Web_Event_Event.target(e))(function (v) {
                  return Control_Bind.bind(Data_Maybe.bindMaybe)(Web_HTML_HTMLElement.fromEventTarget(v))(function (v1) {
                      return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Applicative.pure(Data_Maybe.applicativeMaybe)($foreign.getScrollTop(v1)))(function (v2) {
                          return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(UserScroll.create(v2));
                      });
                  });
              });
          })) ])([ tableView(st) ]) ]) ]);
  ...
  exports["calculateVisibleIndices"] = calculateVisibleIndices;
  exports["UserScroll"] = UserScroll;
